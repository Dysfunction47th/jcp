  ...
  <header>
      <div class="inner">
          ...
          <ul id="gnb">
              ...
              <li><a href="./trendPage.html" >지금 트랜드</a></li>
              ...
              <!-- <li><a href="#">메인</a></li> -->
              <li id=""><a href="mainPage.html">메인게시판</a></li>
       ...
       <div class="section">
           <div class="recommendation-title"> <h1>무신사 남성 가을</h1></div>
                <div class="product-container">
                    ...
                    <div class="product">
                        <img src="/asset/testimg/test_men6.jpg" alt="6번째 콘텐츠 이미지">
                        <a href="https://www.musinsa.com/app/goods/3263933?loc=goods_rank">
                        <h2 class="title">Snow cargo Denim BLACK</h2>
                        </a>
                        <p class="description">
                            - 맥시한 기장감   <br>
                            - 스노우 워싱 기법으로 <br>
                    ...
                    <div class="product">
                        <img src="/asset/testimg/test_men7.jpg" alt="7번째 콘텐츠 이미지">
                        <a href="https://www.musinsa.com/app/goods/2704962?loc=goods_rank">
                        <h2 class="title">(23FW) WARM+ UP QUILTING JACKET BLACK</h2>
                        </a>
                        <p class="description">
                            - 바로 세탁   <br>
                            - 땀 흘렸을 시  즉시 세탁<br>
                    ...
                    <div class="product">
                        <img src="/asset/testimg/test_men8.jpg" alt="8번째 콘텐츠 이미지">
                        <a href="https://www.musinsa.com/app/goods/2996544?loc=goods_rank">
                        <h2 class="title">올데이 라운드 니트</h2>
                        </a>
                        <p class="description">
                    ...
                    <div class="product">
                        <img src="/asset/testimg/test_men9.jpg" alt="9번째 콘텐츠 이미지">
                        <a href="https://www.musinsa.com/app/goods/2086653?loc=goods_rank">
                        <h2 class="title">레이어드 크루 넥 반팔 티셔츠_일반 기장 [화이트]</h2>
                        </a>
                        <p class="description">
                            - 다양한 룩에 레이어드용으로 활용   <br>
                            - 편안한 착용감<br>
                            - 트렌디한 레이어드 룩을 연출
                        </p>
                    </div>
                    <div class="product">
                        <img src="/asset/testimg/test_men10.jpg" alt="10번째 콘텐츠 이미지">
                        <a href="https://www.musinsa.com/app/goods/1778408?loc=goods_rank">
                        <h2 class="title">2WAY 스웻 후드 집업 (BLACK)</h2>
                        </a>
                        <p class="description">
                            - cvc 원단    <br>
                            - 오버핏으로 편안한 착용감<br>
            ...
            <div class="section">
                <div class="recommendation-title"><h1>무신사 여성 가을</h1></div>
                    <div class="product-container">
                        ...
                        <div class="product">
                            <img src="/asset/testimg/test_women6.jpg" alt= "6번쨰 콘텐츠 이미지">
                            <a href="https://www.musinsa.com/app/goods/3548973">
                            <h2 class="title">KNIT EARFLAP BEANIE black </h2>
                            </a>
                            <p class="description">
                                - 물세탁 금지    <br>
                                - 기계 건조 사용시 손상<br>
                            ...
                            <img src="/asset/testimg/test_women7.jpg" alt= "7번쨰 콘텐츠 이미지">
                            <a href="https://www.musinsa.com/mz/brandsnap/view/357805">
                            <h2 class="title">디스트레스드 후디 (크림)  </h2>
                            </a>
                            <p class="description">
                                - 뒤집어서 세탁    <br>
                                -강한 마찰과 가방에 자주 닿는 부위에는 울풀림과 보풀이 일어남 <br>
                                
                            </p>
                        </div><div class="product">
                            <img src="/asset/testimg/test_women8.jpg" alt= "8번쨰 콘텐츠 이미지">
                            <a href="https://www.musinsa.com/app/goods/3590463?loc=goods_rank">
                            <h2 class="title"> [Woman]글로시 다운 크롭 푸퍼 패딩_Glossy Pink </h2>
                            </a>
                            <p class="description">
                                - 서늘한 곳에서 보관    <br>
                                - 드라이 클리닝<br>
                            ...
                            <img src="/asset/testimg/test_women9.jpg" alt= "9번쨰 콘텐츠 이미지">
                            <a href="https://www.musinsa.com/app/goods/2874755?loc=goods_rank">
                            <h2 class="title">Sac de Velo Mini </h2>
                            </a>
                            <p class="description">
                            ...
                            <img src="/asset/testimg/test_women10.jpg" alt= "10번쨰 콘텐츠 이미지">
                            <a href="https://www.musinsa.com/app/goods/1421748?loc=goods_rank">
                            <h2 class="title"> Shoulder Strap Flare Dress Black </h2>
                            </a>
                            <p class="description">
                                - 숄더 스트랩   <br>
                                - 사이드 한쪽 주름 디테일<br>
