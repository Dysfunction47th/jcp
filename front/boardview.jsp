...
function submit_modify(){
	document.form1.action="boardmodify.jsp";
	document.form1.submit();
	return false;
}
function submit_reply(){
	document.form1.action="boardreply.jsp";
	document.form1.submit();
	return false;
}
function submit_delete(){
	alert("정말로 삭제하시겠습니까?");
	document.form1.action="boardelete.jsp";
	document.form1.submit();
	return false;
}
...
<td width="40%">내용</td>
<td width="60%">
<textarea rows="5" cols="60" readonly> <%=contents %></textarea></td>
</tr>
<tr>
<td colspan="2">
<form name="form1" method="post"> 
	<input type="button" value="수정하기"class="paging4" onclick="submit_modify()">
	<input type="button" value="답변달기"class="paging4" onclick="submit_reply()">
	<input type="button" value="삭제하기" class="paging4" onclick="submit_delete()">
